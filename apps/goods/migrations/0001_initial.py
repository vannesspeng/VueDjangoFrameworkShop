    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.IntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类名')], help_text='类目级别', verbose_name='类目级别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.CharField(blank=True, max_length=300, null=True, verbose_name='商品图片url')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
